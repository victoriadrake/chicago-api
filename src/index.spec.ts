...
/*
 * Based on https://github.com/blakeembrey/change-case/blob/master/packages/title-case/src/index.spec.ts
 * ...which is based on https://github.com/gouch/to-title-case/blob/master/test/tests.json
 */
